...
// docs/architecture.md §6 and docs/architecture.md §11. It owns the
...
// docs/architecture.md §13 (Hybrid Access Model). It wraps the freshly-
...
var (
	...
	// Promote (per docs/architecture.md §6: simulate-before-promote).
...
// docs/architecture.md §6 Simulate is the only path that populates
...
func (s *PolicyService) Simulate(ctx context.Context, workspaceID, policyID string) (*ImpactReport, error) {
	...
	// is this draft?". Per docs/architecture.md §9 the AI is decision-support
...
func (s *PolicyService) Promote(ctx context.Context, workspaceID, policyID, actorUserID string) (*models.Policy, error) {
	...
	//
	// Phase 11 (docs/architecture.md §13): when the writer also
