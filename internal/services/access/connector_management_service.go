...
type ConnectResult struct {
	...
	// AccessMode is the docs/architecture.md §13 access mode the platform
...
func (s *ConnectorManagementService) Connect(ctx context.Context, in ConnectInput) (*ConnectResult, error) {
	...
	// AccessMode (per docs/architecture.md §13). Best-effort: if the
...
// docs/architecture.md §13 access mode classification. Operators use it
