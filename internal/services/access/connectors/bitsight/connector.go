...
// identity directory the platform consumes via this connector, so
// SyncIdentities returns an empty batch immediately. Validate / Connect
// still verify the bearer token against the public probe endpoint.
package bitsight
...
var ErrNotImplemented = errors.New("bitsight: capability not implemented in Phase 7")
...
func (c *BitSightAccessConnector) ProvisionAccess(_ context.Context, _, _ map[string]interface{}, _ access.AccessGrant) error {
	return ErrNotImplemented
}
func (c *BitSightAccessConnector) RevokeAccess(_ context.Context, _, _ map[string]interface{}, _ access.AccessGrant) error {
	return ErrNotImplemented
}
func (c *BitSightAccessConnector) ListEntitlements(_ context.Context, _, _ map[string]interface{}, _ string) ([]access.Entitlement, error) {
	return nil, ErrNotImplemented
}
func (c *BitSightAccessConnector) GetSSOMetadata(_ context.Context, _, _ map[string]interface{}) (*access.SSOMetadata, error) {
	return nil, nil
}
