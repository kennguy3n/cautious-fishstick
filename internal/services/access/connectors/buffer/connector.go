...
var ErrNotImplemented = errors.New("buffer: capability not implemented in Phase 7")
...
func (c *BufferAccessConnector) GetSSOMetadata(_ context.Context, _, _ map[string]interface{}) (*access.SSOMetadata, error) {
	return nil, nil
}
