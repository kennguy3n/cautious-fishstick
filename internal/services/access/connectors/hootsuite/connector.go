...
var ErrNotImplemented = errors.New("hootsuite: capability not implemented in Phase 7")
...
func (c *HootsuiteAccessConnector) GetSSOMetadata(_ context.Context, _, _ map[string]interface{}) (*access.SSOMetadata, error) {
	return nil, nil
}
