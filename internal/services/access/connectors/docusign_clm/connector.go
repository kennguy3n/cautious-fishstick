...
var ErrNotImplemented = errors.New("docusign_clm: capability not implemented in Phase 7")
...
type docusign_clmListResponse struct {
	Items []docusign_clmUser `json:"users"`
}
...
func (c *DocuSignCLMAccessConnector) SyncIdentities(
	...
	for {
		...
		var resp docusign_clmListResponse
...
func (c *DocuSignCLMAccessConnector) GetSSOMetadata(_ context.Context, _, _ map[string]interface{}) (*access.SSOMetadata, error) {
	return nil, nil
}
