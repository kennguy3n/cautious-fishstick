...
// (agent-to-agent) skill server per docs/architecture.md §7 and
...
// (docs/architecture.md §9). InvokeSkill never panics; transport / decode
...
// docs/architecture.md §12 (AI agent only authenticated via shared
...
// get the docs/architecture.md §9 fallback (empty list on unreachable AI).
