...
// AccessRequest mirrors the access_requests table per docs/architecture.md §11
// and docs/architecture.md §5. One row per "user X asks for role Y on
...
// access_requests (matching the migration and docs/architecture.md §11).
