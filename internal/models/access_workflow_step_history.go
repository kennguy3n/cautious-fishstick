...
// table per docs/internal/PHASES.md Phase 8 Task 4. One row per workflow step
...
type AccessWorkflowStepHistory struct {
	...
	// BranchIndex is set when the executor walks a DAG step. All DAG
	// steps (including root nodes) receive a non-nil value equal to
	...
	// branch_index, status) per docs/internal/PHASES.md Phase 8 DAG criteria.
