...
// shape in docs/overview.md §11 ("POST /access/connectors" + verbs).
...
// access_mode (docs/overview.md §13). Future Phase 11 follow-ups
...
// supports admin override of the connector's docs/overview.md §13
