...
//
// Per docs/internal/PHASES.md cross-cutting criteria, handlers MUST NOT touch
...
// docs/internal/PHASES.md cross-cutting criteria).
...
// pattern is consistent across the codebase (per docs/internal/PHASES.md
