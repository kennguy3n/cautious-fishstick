...
│   │       ├── stripe/            # Stripe /v1/team_members (starting_after cursor) — Validate, Connect, Sync
...
| 3 | Business SaaS | 55 | 26 / 55 | **Implemented:** Slack, MS Teams, Zoom, Notion, Asana, Monday.com, Figma, Miro, Trello, Airtable, Smartsheet, ClickUp, Salesforce, HubSpot, Zoho CRM, Pipedrive, Dropbox Business, Box, GitHub, GitLab, Jira, PagerDuty, Sentry, Zendesk, Freshdesk, Help Scout. **Pending:** Egnyte, Terraform, Docker Hub, JFrog, SonarCloud, CircleCI, Travis CI, LaunchDarkly, Datadog, New Relic, Splunk Cloud, Grafana, Mezmo, Sumo Logic, Front, Intercom, Drift, … |
| 4 | HR / Finance / Legal | 50 | 10 / 50 | **Implemented:** BambooHR, Gusto, Rippling, Personio, Hibob, Workday, QuickBooks, Xero, Stripe, FreshBooks. **Pending:** Paychex, Deel, Zenefits, Namely, Wave, Sage Intacct, Bill.com, Expensify, Plaid, Brex, Ramp, Clio, Ironclad, DocuSign, DocuSign CLM, PandaDoc, HelloSign, MyCase, … |
