...
| 5 | Vertical / Niche | 70 | 13 / 70 | **Implemented:** CrowdStrike, SentinelOne, Snyk, Cisco Meraki, Fortinet, Zscaler, Check Point, Palo Alto Prisma, NordLayer, Perimeter 81, Netskope, Sophos Central, Sophos XG. **Pending:** HackerOne, HIBP, BitSight, Tenable.io, Qualys VMDR, Rapid7, VirusTotal, ForgeRock, BeyondTrust, Keeper, real estate (Yardi, Buildium, AppFolio), healthcare (Practice Fusion, Kareo, Zocdoc), e-commerce (Shopify, WooCommerce, BigCommerce, Magento, Square), supply chain (NetSuite), … |
| | **Total** | **200** | **143 / 200** | |
