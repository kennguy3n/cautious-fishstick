...
| 4 | HR / Finance / Legal / Sales / Marketing | 50 | 20 / 50 | **Implemented:** BambooHR, Gusto, Rippling, Personio, Hibob, Workday, QuickBooks, Xero, Stripe, FreshBooks, Paychex, Deel, Zenefits, Namely, PayPal, Wave, Gong, Salesloft, Mailchimp, Klaviyo. **Pending:** Sage Intacct, Bill.com, Expensify, Plaid, Brex, Ramp, Clio, Ironclad, DocuSign, DocuSign CLM, PandaDoc, HelloSign, MyCase, Apollo.io, Copper, Insightly, Close, ActiveCampaign, Constant Contact, Braze, Mixpanel, Segment, Typeform, SurveyMonkey, Eventbrite, Navan, SAP Concur, Coupa, Anvyl, … |
