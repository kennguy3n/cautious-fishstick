...
| 3 | Business SaaS | 55 | 22 / 55 | **Implemented:** Slack, MS Teams, Zoom, Notion, Asana, Monday.com, Figma, Miro, Trello, Airtable, Salesforce, HubSpot, Zoho CRM, Pipedrive, GitHub, GitLab, Jira, PagerDuty, Sentry, Zendesk, Freshdesk, Help Scout. **Pending:** Smartsheet, ClickUp, Dropbox Business, Box, Egnyte, Terraform, Docker Hub, JFrog, SonarCloud, CircleCI, Travis CI, LaunchDarkly, Datadog, New Relic, Splunk Cloud, Grafana, Mezmo, Sumo Logic, Front, Intercom, Drift, … |
