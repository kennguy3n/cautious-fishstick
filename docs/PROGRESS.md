...
- **Why.** 37 of 200 providers remain `⏳` after the Phase 7 Tier-4 closeout, first Tier-5 Network Security batch (PR #16), and Tier-5 Security / IAM / GenAI batch (PR #17) — Tier 3 is now 55/55 complete; Tier 4 is now 50/50 complete; Tier 5 sits at 33/70 with Security / IAM / GenAI added.
