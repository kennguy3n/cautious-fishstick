...
| Date | What | PR |
|------|------|----|
| 2026-05-15 | Group B — SSOEnforcementChecker for Dropbox + Zoom (12 → 14, finally matching README), Makefile + CONTRIBUTING.md, registry orphan-directory + optional-interface count guards (`SCIMProvisioner=8`, `GroupSyncer=5`, `IdentityDeltaSyncer=3`, `AccessAuditor=198`), logging middleware redaction + duration tests, docker-compose healthcheck guard. | #81 |
