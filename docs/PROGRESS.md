...
- **Why.** 97 of 200 providers remain `⏳` after the Phase 7 expansion shipped in PR #14 (Tier 3 is now 55/55 complete; Tier 4 sits at 20/50).
- **Scope.** The remaining Tier 4 (Sage Intacct, Bill.com, Expensify, Plaid, Brex, Ramp, Clio, Ironclad, DocuSign, DocuSign CLM, MyCase, PandaDoc, PandaDoc CLM, HelloSign, Apollo.io, Copper, Insightly, Close, ActiveCampaign, Constant Contact, Braze, Mixpanel, Segment, Typeform, SurveyMonkey, Eventbrite, Navan, SAP Concur, Coupa, Anvyl) and the entire Tier 5 catalogue.
