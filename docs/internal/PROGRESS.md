...
| Date | What | PR |
|------|------|----|
| 2026-05-15 | Group C — Phase 11 promoted to ✅ across `PHASES.md` / `PROGRESS.md`; cross-doc terminology fix five-layer → six-layer leaver kill switch; SCIM 10 → 8 audit note (`generic_saml` + `generic_oidc` n/a — no upstream API). Zoom `AccountID` URL-escape consistency follow-up landed separately in #84. | this PR |
